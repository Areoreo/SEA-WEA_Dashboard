...
//     useEffect(() => {
//         fetch("/data/processed_reservoir_data.json")
...
//                                         {selectedBasin.basin}
//                                     </h4>
//                                     <p className="text-sm text-green-600">Basin Summary</p>
//                                 </div>
//                                 <div className="grid grid-cols-2 gap-4 text-sm">
//                                     <div className="space-y-2">
//                                         <div className="flex justify-between">
//                                             <span className="font-medium">Total:</span>
//                                             <span className="font-bold">{selectedBasin.total}</span>
//                                         </div>
//                                         <div className="flex justify-between">
...
//                                                     ? `${selectedMarker.normal_capacity_mcm} MCM`
//                                                     : "N/A"}
//                                             </div>
//                                             <div>
//                                                 <span className="font-medium">Height: </span>
//                                                 {selectedMarker.dam_height_m
//                                                     ? `${selectedMarker.dam_height_m}m`
//                                                     : "N/A"}
//                                             </div>
//                                         </>
//                                     )}
...
//                                                     ? `${selectedMarker.power_mw} MW`
//                                                     : "N/A"}
//                                             </div>
//                                             <div>
//                                                 <span className="font-medium">Head: </span>
//                                                 {selectedMarker.water_head_m
//                                                     ? `${selectedMarker.water_head_m}m`
//                                                     : "N/A"}
//                                             </div>
//                                         </>
//                                     )}
